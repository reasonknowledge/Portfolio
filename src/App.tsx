...
export default function App() {
  ...
  return (
    <div className="min-h-max mx-auto flex flex-col">
      <div className="flex flex-col items-center gap-3 justify-center">
        <div className="flex flex-col p-2 sm:gap-3 sm:grid sm:grid-cols-[1fr_2fr] dark:bg-card border sm:flex-row sm:w-3/4 sm:justify-center mt-2">
          ...
          <div className="p-6">
            ...
            <BoxReveal>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="mt-4">
                  <Button className="cursor-pointer bg-white text-black border border-gray-300 hover:text-blue-300 hover:bg-white dark:bg-transparent dark:text-white">
        ...
        <div className="flex flex-col gap-10 items-center w-full justify-center">
          <div className="sm:w-3/4 sm:gap-3 sm:flex flex flex-col">
            <div className="flex flex-col sm:grid sm:grid-cols-[2fr_1fr] gap-3">
              <div className="sm:mx-auto w-full h-full border rounded-lg overflow-hidden dark:bg-card">
            ...
            <div className="flex flex-col gap-3 sm:grid sm:grid-cols-[1fr_2fr] sm:gap-3">
              <button className="border rounded-lg dark:bg-card" type="button" onClick={OpenDialog}>
          ...
          <div className="sm:flex sm:justify-center sm:w-full sm:gap-6 lg:p-3">
            <a
              ...
              className="w-1/4 bg-white hover:bg-white dark:bg-card border rounded-lg overflow-hidden sm:h-full"
            >

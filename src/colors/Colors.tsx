...
// Personal colors
export const color1 = "#37B5B5";
export const color2 = "#18A0FB";
export const color3 = "rgba(55,181,181,.25)";
export const color4 = "#37B5B5";
export const color5 = "rgba(16, 214, 214, 0.25)";
export const color6 = "rgba(5, 247, 247, 0.25)";
export const bluespecial = "#00BFFF";
export const AreaCharColor = "#90CAF9";
export const blueCollect = "#0960ac";



export const _gradientrgbablack20 = "rgba(0, 0, 0, 0.20)";
export const _gradientrgbablack30 = "rgba(0, 0, 0, 0.30)";
export const _gradientrgbablack40 = "rgba(0, 0, 0, 0.40)";
export const _gradientrgbablack50 = "rgba(0, 0, 0, 0.50)";
export const _gradientrgbablack60 = "rgba(0, 0, 0, 0.60)";
export const _gradientrgbablack70 = "rgba(0, 0, 0, 0.70)";
export const _gradientrgbablack80 = "rgba(0, 0, 0, 0.80)";

export const halthcolor1_20 = "rgba(55, 181, 181, 0.20)";
export const halthcolor1_25 = "rgba(55, 181, 181, 0.25)";
export const halthcolor1_50 = "rgba(55, 181, 181, 0.50)";
export const halthcolor1_75 = "rgba(55, 181, 181, 0.75)";

// Rouges avec opacités
export const redOpacity20 = "rgba(255, 0, 0, 0.2)";
export const redOpacity30 = "rgba(255, 0, 0, 0.3)";
export const redOpacity40 = "rgba(255, 0, 0, 0.4)";
export const redOpacity50 = "rgba(255, 0, 0, 0.5)";
export const redOpacity60 = "rgba(255, 0, 0, 0.6)";
export const redOpacity70 = "rgba(255, 0, 0, 0.7)";
export const redOpacity80 = "rgba(255, 0, 0, 0.8)";
export const redcustom = "#ff4444";
// Tailwind CSS Colors in Hexadecimal

// Gray shades
export const _graygradient1 = "#e9e9e9";
export const _graygradient2 = "#f1f1f1";
export const graysepecial = "#f5f5f5";
...
export const lightBlue950 = "#083344";

// Dark Blue shades
export const darkBlue50 = "#F3F4F6";
export const darkBlue100 = "#E5E7EB";
export const darkBlue200 = "#D1D5DB";
export const darkBlue300 = "#9CA3AF";
export const darkBlue400 = "#6B7280";
export const darkBlue500 = "#4B5563";
export const darkBlue600 = "#374151";
export const darkBlue700 = "#1F2937";
export const darkBlue800 = "#111827";

// Purple shades
export const purple50 = "#F5F3FF";
export const purple100 = "#EDE9FE";
export const purple200 = "#DDD6FE";
export const purple300 = "#C4B5FD";
export const purple400 = "#A78BFA";
export const purple500 = "#8B5CF6";
export const purple600 = "#6D28D9";
export const purple700 = "#4C1D95";
export const purple800 = "#3B0F77";
export const purple900 = "#1E040F";
export const purple950 = "#500724";
